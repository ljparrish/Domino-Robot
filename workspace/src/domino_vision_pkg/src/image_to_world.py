...
class Image_to_world:
    def __init__(self):
        ...
        self.ox = 0.0
        self.oy = 0.0
        self.dom_sub = rospy.Subscriber("/image_info", game_state, self.image_to_world)
        rospy.spin()
    ...
    def image_to_world(self, msg): 
        ...
        self.world_pub = rospy.Publisher('/board_info',world_coordinates, queue_size = 10)
        r = rospy.Rate(10)      
        pub_string = world_coordinates(x = X, y = Y, z = Z, num_dots_half1 = num_dots1, num_dots_half2 = num_dots2, orientation = orientation)
